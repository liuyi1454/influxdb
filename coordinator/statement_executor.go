...
func (e *StatementExecutor) executeShowFieldKeyCardinalityStatement(ctx *query.ExecutionContext, stmt *influxql.ShowFieldKeyCardinalityStatement) (models.Rows, error) {
	measurementsFieldKeys, err := e.TSDBStore.FieldKeys(ctx, ctx.ExecutionOptions.CoarseAuthorizer, stmt.Sources)
...
type TSDBStore interface {
	...
	FieldKeys(ctx context.Context, auth query.CoarseAuthorizer, sources influxql.Sources) (map[string][]string, error)
